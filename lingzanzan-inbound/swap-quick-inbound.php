...
try {
  ...
  echo 'feedback=' . copy_swap($assets . '/submission-feedback.js.new-quick-inb-1', $assets . '/submission-feedback.js') . "\n";
  ...
  $feedback = file_get_contents($assets . '/submission-feedback.js') ?: '';
  ...
  echo 'htmlMark=' . (strpos($html, 'quick-inb-10') !== false ? 'yes' : 'no') . "\n";
  ...
  echo 'recvDel=' . (strpos($js, 'LZ_RECV_DEL_20260926') !== false && strpos($api, 'LZ_RECV_DEL_20260926') !== false ? 'yes' : 'no') . "\n";
  echo 'feedbackDel=' . (strpos($feedback, '資料刪除失敗') !== false ? 'yes' : 'no') . "\n";
